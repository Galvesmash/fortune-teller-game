...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", _hoisted_1, [
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("div", _hoisted_2, [
            (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("h1", _hoisted_3, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.$t('general.fortune_game')), 1),
...
const FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_withScopeId = n => (_pushScopeId("data-v-7689c8b6"), n = n(), _popScopeId(), n);
const FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_hoisted_1 = { class: "fortune-card" };
const FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_hoisted_2 = {
    key: 0,
    class: "fortune"
};
const FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_hoisted_3 = {
    key: 1,
    class: "fortune error"
};
function FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_hoisted_1, [
        (!_ctx.fortuneError && (_ctx.fortuneTranslated || _ctx.fortune))
            ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("p", FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_hoisted_2, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.fortuneTranslated || _ctx.fortune), 1))
            : (_ctx.fortuneError)
                ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("p", FortuneCardvue_type_template_id_7689c8b6_scoped_true_ts_true_hoisted_3, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.$t('general.fortune_machine_error')) + " " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.$t('general.try_again_later')), 1))
                : (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createCommentVNode)("", true)
    ]));
}

;// CONCATENATED MODULE: ./src/components/FortuneCard.vue?vue&type=template&id=7689c8b6&scoped=true&ts=true

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/FortuneCard.vue?vue&type=script&lang=ts
...
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-22.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-22.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-22.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-22.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/FortuneCard.vue?vue&type=style&index=0&id=7689c8b6&scoped=true&lang=scss
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/components/FortuneCard.vue?vue&type=style&index=0&id=7689c8b6&scoped=true&lang=scss
 ...
 */
const registerOrCreateStore = (vueInstance, newStoreKey, newStore) => {
...
;// CONCATENATED MODULE: ./src/store/fortune_teller/fortune/getters.ts
/* harmony default export */ var getters = ({
    getFortune: (state) => {
        return state.fortune;
    },
    getFortuneError: (state) => {
        return state.fortune_error;
    },
    getFortuneOptions: (state) => {
        return state.fortune_options;
    },
    getFortuneTranslated: (state) => {
...
;// CONCATENATED MODULE: ./src/store/fortune_teller/fortune/actions.ts

/* harmony default export */ var actions = ({
    /*
     * GET
     */
    getFortune({ commit, state }) {
        return new Promise((resolve, reject) => {
            lib_axios.get(`https://${state.rapidApiUrl}/slack`, {
                headers: {
                    'Content-Type': 'application/json',
...
;// CONCATENATED MODULE: ./src/store/fortune_teller/fortune/mutations.ts
/* harmony default export */ var mutations = ({
    ...
    setFortuneOptions(state, payload) {
        state.fortune_options = payload || [];
    },
    setFortuneError(state) {
        state.fortune = '';
        state.fortune_error = true;
        state.fortune_translated = '';
    },
    setFortuneTranslated(state, payload) {
        state.fortune_error = false;
        state.fortune_translated = payload;
    },
    setRapidApiKeyFortune(state, payload) {
        state.rapidApiKey = payload || '';
    },
});

;// CONCATENATED MODULE: ./src/store/fortune_teller/fortune/index.ts
...
/* harmony default export */ var fortune = ({
    namespaced: true,
    state,
    getters: getters,
    actions: actions,
...
;// CONCATENATED MODULE: ./src/store/fortune_teller/general/actions.ts

/* harmony default export */ var general_actions = ({
    /*
     * POST
     * @param text: string
     * @param target: string
     */
    translate({ commit, state }, payload = null) {
        return new Promise((resolve, reject) => {
            lib_axios.post(`https://${state.rapidApiUrl}/translate`, payload, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-RapidAPI-Host': state.rapidApiUrl,
                    'X-RapidAPI-Key': state.rapidApiKey,
...
;// CONCATENATED MODULE: ./src/store/fortune_teller/general/mutations.ts
/* harmony default export */ var general_mutations = ({
    setLocale(state, payload) {
        state.locale = payload;
    },
    setRapidApiKeyGeneral(state, payload) {
        state.rapidApiKey = payload || '';
    },
});

;// CONCATENATED MODULE: ./src/store/fortune_teller/general/index.ts
...
;// CONCATENATED MODULE: ./src/store/fortune_teller/index.ts


/* harmony default export */ var fortune_teller = ({
    namespaced: true,
    state: {
    // 
    },
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/FortuneGame.vue?vue&type=script&lang=ts
